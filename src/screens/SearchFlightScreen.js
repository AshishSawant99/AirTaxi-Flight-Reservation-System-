    ...
    return (
      <div class="jumbotron1">
        ...
        {this.state.passengers.length > 0 && (
          <div class="row-6" Style="align-self: center;">
            {this.state.passengers.map((i) => {
              //console.log(i);
              return (
                <div class="card text-center my-4 col-6 "style={{background:"lightslategray",marginLeft:"350px"}} >
                  <div class="card-body">
        ...
        {this.state.selectedFlight !== null && (
          <div class="row-6">
            <div style={{background :"aliceblue" ,width:"500px", height:"600",marginLeft:"500", float:"left"}} class="card text-center my-4 col">
            ...
            <div class="card text-center my-4 col" style={{background:"aliceblue"}}>
        ...
        {this.state.selectedFlight !== null && (
          <button onClick={this.confirmBooking} class="btn btn-danger">
